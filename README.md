...
- On your local machine:
	- Linux or MacOS, not Windows
        Windows is not compatible with Docker Compose, which is needed for Superset
...
Store environment variables locally in your .bashrc file.
...
2. Run the following two SQL scripts in your Trino SQL editor against the target Iceberg instance. Update schema name here and below as appropriate.
	- [005_jimmybrock.staging_daily_stock_price_cumulative-create_table.sql](sql/iceberg/005_jimmybrock.staging_daily_stock_price_cumulative-create_table.sql)
	- [010_jimmybrock.daily_stock_price_cumulative-create_table.sql](sql/iceberg/010_jimmybrock.daily_stock_price_cumulative-create_table.sql)
...
5. Run the following SQL scripts in the Trino SQL editor against the target Iceberg database:
	- [020_jimmybrock.daily_stock_price_cumulative-backfill.sql](sql/iceberg/020_jimmybrock.daily_stock_price_cumulative-backfill.sql)
	- [025_jimmybrock.daily_stock_split-create_table.sql](sql/iceberg/025_jimmybrock.daily_stock_split-create_table.sql)
	- [030_jimmybrock.dim_daily_stock_price-create_table.sql](sql/iceberg/030_jimmybrock.dim_daily_stock_price-create_table.sql)
	- [040_jimmybrock.current_day_stock_price-create_table.sql](sql/iceberg/040_jimmybrock.current_day_stock_price-create_table.sql)
